...
const Chatbot = () => {
  ...
  const getBotResponse = (userInput) => {
    ...
    if (input.includes('contacto') || input.includes('whatsapp') || input.includes('telefono')) {
      return "Puedes contactarnos por WhatsApp al +506 7047-0555 o visitar nuestra sección de Contacto. Estamos disponibles para responder todas tus preguntas.";
    }
    ...
    return "Gracias por tu mensaje. Para información más detallada sobre nuestros servicios, precios o disponibilidad, te recomiendo contactarnos directamente por WhatsApp al +506 7047-0555. ¿Hay algo más en lo que pueda ayudarte?";
  };
