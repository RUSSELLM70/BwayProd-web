        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <motion.div variants={fadeIn} className="bg-surface-highlight p-8 rounded-lg border border-dark-gray-border">
            <div className="space-y-4 font-poppins">
              <p><span className="text-text-secondary">Call Today:</span> <a href="tel:+50670470555" className="hover:text-lime-accent transition-colors">+506 7047-0555</a></p>
              <p><span className="text-text-secondary">Email:</span> <a href="mailto:booking@bwayprod.com" className="hover:text-lime-accent transition-colors">booking@bwayprod.com</a></p>
            </div>
